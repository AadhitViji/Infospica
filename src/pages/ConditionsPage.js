  ...
  return (
    <div className="conditions-container">
      ...
      <div className="conditions-section">
        <h2>If</h2>
        <label htmlFor="drivingAge" className="conditions-label">Age</label>
        <input
          id="drivingAge"
        ...
        />
        <div className="conditions-helper">If age is 18 or more, you can drive.</div>
        <p className="conditions-badge">{ifMessage()}</p>
      </div>

      <div className="conditions-section">
        <h2>If...Else</h2>
        <label htmlFor="greetingHour" className="conditions-label">Hour (0-23)</label>
        <input
          id="greetingHour"
          className="conditions-input"
          type="number"
        ...
        />
        <div className="conditions-helper">Before 18 → Good day, otherwise → Good evening.</div>
        <p className="conditions-badge">{greetingMessage()}</p>
      </div>

      <div className="conditions-section">
        <h2>If...Else If...Else</h2>
        <label htmlFor="scoreInput" className="conditions-label">Score</label>
        <input
          id="scoreInput"
          className="conditions-input"
          type="number"
        ...
        />
        <div className="conditions-helper">90+: A, 75+: B, 60+: C, 40+: D, else F.</div>
        <p className="conditions-badge">{gradeMessage()}</p>
      </div>

      <div className="conditions-section">
        <h2>Switch</h2>
        <label htmlFor="daySelect" className="conditions-label">Select a day</label>
        <select id="daySelect" className="conditions-select" value={dayIndex} onChange={handleDayChange}>
      ...
      <div className="conditions-section">
        <h2>Ternary (? :)</h2>
        <label htmlFor="adultAge" className="conditions-label">Age</label>
        <input
          id="adultAge"
          className="conditions-input"
          type="number"
          ...
          placeholder="Enter your age"
        />
        <div className="conditions-helper"><code>age {'>='} 18 ? Adult : Minor</code></div>
      ...
      <div className="conditions-section">
        <h2>Booleans</h2>
        <label>
          <input type="checkbox" checked={flag} onChange={handleFlagToggle} /> Toggle flag
        </label>
      ...
      <div className="conditions-section">
        ...
        <div className="checkbox-row">
          <label>
            <input type="checkbox" checked={condA} onChange={handleCondAToggle} /> A
          </label>
          <label>
            <input type="checkbox" checked={condB} onChange={handleCondBToggle} /> B
          </label>
        </div>
